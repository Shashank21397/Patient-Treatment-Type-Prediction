...
def marks(request):
    if(request.method=="POST"):
        ...
        if('buttonpredict' in request.POST):
            import pandas as pd
            path="/Users/shashank A U/Desktop/day2/Data/Exammarks.csv"
...
def about(request):
    data = pd.read_csv(r"C:\Users\shashank A U\OneDrive\Desktop\Patient_treatment_type_Prediction\Patient-Treatment-Type-Prediction\GUI\basics\data.csv")
